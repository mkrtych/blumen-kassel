...
This project is a commercial website in Germany. Final legal texts must be reviewed with a suitable German legal text generator or a lawyer before production launch and active promotion.

## Known Legal Data

- Business name: Emma Mkrtchian & Anna Mkrtchian GbR
...
## External Services Used Or Planned

- Cloudflare Pages / Cloudflare hosting
- Instagram link, currently preferred as external link only
- WhatsApp link
- Google Maps link, currently preferred as external link only

## Privacy And Cookie Status

- No contact form for now
- No online payment for now
- No newsletter for now
- No Google Analytics for now
- No Meta Pixel for now
- No direct Instagram embed/feed for now
- No direct Google Maps embed for now
- Only informational landing page for now

Prefer simple external links before embedded third-party widgets to reduce privacy and cookie complexity.
